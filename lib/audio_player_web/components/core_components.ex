defmodule AudioPlayerWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AudioPlayerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AudioPlayerWeb.Gettext, "errors", msg, opts)
    end
  end
